...
print("R-squared: " + str(model.score(train_X, train_y)))
...
pickle.dump(model, open(os.path.dirname(os.getcwd()) + "/ML/sgd_model.pkl", "wb"))
...
def plot_pred_y_test_chart():
    ...
    #plt.savefig(os.path.dirname(os.getcwd()) + "\Data_Vis\plots\SGD_Reg.svg")
    fig.show()
